...
import static uk.co.caprica.picam.bindings.MmalParameters.MMAL_PARAMETER_IMAGE_EFFECT;
...
public class MMAL_PARAMETER_IMAGEFX_T extends ParameterStructure {
	...
	public MMAL_PARAMETER_IMAGEFX_T() {
		super(MMAL_PARAMETER_IMAGE_EFFECT);
	}

	public MMAL_PARAMETER_IMAGEFX_T(Pointer peer) {
		super(peer);
	}
